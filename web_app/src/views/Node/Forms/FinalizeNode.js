      ...
      content: (
        <Card className="delegationCard">
          ...
          <h5 className="finalizingTipsContent">
            ...
            These setting cannot be changed, and you can only finalize a node
            once!
          </h5>
                ...
                {managementType4 && (
                  <>
                    ...
                    <p>
                      ...
                      assets. May apply to the management of any common goods or
                      services.
                    </p>
                  </>
                )}
              ...
              <Card className="slide-right">
                {storageType1 && (
                  <>
                    ...
                    <p>
                      ...
                      distributed file system. IPFS allows users to not only
                      receive but host content, in a similar manner to
                      BitTorrent.
                    </p>
                  </>
                )}
                {storageType2 && (
                  <>
                    ...
                    <p>
                      A novel data storage blockchain protocol enabling a
                      permanent serverless web and creating truly permanent data
