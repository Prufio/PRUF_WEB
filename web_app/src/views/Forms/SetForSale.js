...
export default function SetForSale(props) {
    ...
    const setAssetPrice = async () => { //set asset price
        ...
        <Card>
            ...
            <CardBody>
                <form>
                    ...
                    {!transactionActive && assetInfo.price && (
                        <div className="MLBGradientSubmit">
                            <Button color="info" className="MLBGradient" onClick={() => setAssetPrice()}>Modify Price</Button>
                        </div>
                    )}
                    {!transactionActive && price === "0" (
                        <div className="MLBGradientSubmit">
                            <Button color="info" className="MLBGradient" onClick={() => clearAssetPrice()}>Clear Price</Button>
                        </div>
                    )}
                    {transactionActive && (
                        <h3>
