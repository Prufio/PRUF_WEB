...
export default function Home(props) {
  ...
  const purchaseNode = async () => {
    //create a new asset class record
    let tempTxHash;
        ...
        <GridItem xs={12} sm={6} md={6} lg={3}>
          <Card>
              ...
              {props.IDHolder === true || hasMinted === true ? (
                <>
                  ...
                  <Tooltip title="User already holds an ID token.">
                    <h3 className={classes.cardTitle}>Verified</h3>
                  </Tooltip>
                </>
                ...
                <>
                  ...
                  <p className={classes.cardCategory}>User Status</p>
                  <h3 className={classes.cardTitle}>Not Verified</h3>
                </>
              ) : (
                <>
                  <CardIcon className="headerIconBack">
            ...
            <CardFooter stats>
              {props.IDHolder === true || hasMinted === true ? (
                <>
                  <div className={classes.stats}>User Holds ID</div>
                </>
              ) : props.IDHolder === false ? (
                !isMinting ? (
                  <>
            ...
            <CardHeader color="danger" stats icon>
              ...
              {updatedPruf ? (
                ...
                <h3 className={classes.cardTitle}>
                  {props.pruf !== "~" ? (
                    <>
                      {String(Math.round(Number(props.pruf) * 100) / 100)}{" "}
                      <small>PRUF</small>
                    </>
                  ) : (
                    <>
