    ...
    return (
      <div>
        <div>
          ...
          <h2 className="formHeaderMobile">Decrement Counter</h2>
            ...
            <Form.Row>
              {this.state.idxHash !== undefined && (
                <Form.Group>
                  ...
                  <div className="assetSelectedContentHead">Count: <span className="assetSelectedContentMobile">{this.state.count} / {this.state.countDownStart}</span> </div>
                </Form.Group>
              )}
            </Form.Row>
          </div>
...
export default DecrementMobile;
