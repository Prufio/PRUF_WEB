      ...
      <div>
        <div className="homeFormMobile">
          ...
          <div className="mediaLinkMobile">
            ...
            <a className="mediaLinkRefreshContent"><RefreshCw size={20} onClick={() => { if(window.ethereum){window.ethereum.enable() /* window.menuChange = "basicMobile" */ }else{Location.reload()}}} /></a>
